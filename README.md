...
```toml
[dependencies]
oidc-middleware = { version = "0.6.1", default-features = false }
```
...
```toml
[dependencies]
oidc-middleware = { version = "0.6.1", default-features = false, features = ["web-app", "rustls-native-certs"] }
```
